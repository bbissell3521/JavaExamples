...
//-------------------------------------------------------------------------
/**
 * Class designed to make testing the events in SpriteManager and
 * SpriteController easier.
 *
 * Class designed to make testing the events in SpriteManager and
 * SpriteController easier. When the change method is called, the parameters are
 * recorded so they can be accessed later. The events can be cleared which
...
public class TestingSpriteEvent implements SpriteEvent {
	 ...
	 *  There is
	 * no bounds checking and the size of the array is fixed.
	 *
	 * @param size
	 *            Size of the array
	 */
